...
```bash
CloudProjectMarker$ sam local start-api
CloudProjectMarker$ curl http://localhost:3000/
```
...
```bash
CloudProjectMarker$ sam logs -n NetCodeWebAPIServerless --stack-name CloudProjectMarker --tail
```
